...
class Menu:
    ...
    def create_alarm(self):
        ...
        time_frame.pack(anchor="n")
        options_frame = tk.Frame(self.master)
        options_frame.pack(anchor="center")
        tk.Label(time_frame, text="Time : ").grid(row=0, column=0, padx=0, pady=25)
        ...
        tk.Label(options_frame, text="Repeat : ").grid(row=0, column=0, padx=0, pady=0)
        repeat_menu = IntVar()
        r1 = Radiobutton(options_frame, text="Once", value=1, variable=repeat_menu)
        r1.grid(row=0, column=2, padx=3, pady=0)
        r2 = Radiobutton(options_frame, text="Daily", value=2, variable=repeat_menu)
        r2.grid(row=1, column=2, padx=3, pady=0)
        r3 = Radiobutton(options_frame, text="Monday to Friday", value=3, variable=repeat_menu)
        r3.grid(row=2, column=2, padx=3, pady=0)
        r4 = Radiobutton(options_frame, text="Custom", value=4, variable=repeat_menu)
        r4.grid(row=3, column=2, padx=3, pady=0)
